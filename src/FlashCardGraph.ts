...
import * as KeyAccidentalCounts from "./Components/Quizzes/Sheet Music/KeyAccidentalCounts";
import * as KeyAccidentalNotes from "./Components/Quizzes/Sheet Music/KeyAccidentalNotes";
import * as KeySignatureIdentification from "./Components/Quizzes/Sheet Music/KeySignatureIdentification";
