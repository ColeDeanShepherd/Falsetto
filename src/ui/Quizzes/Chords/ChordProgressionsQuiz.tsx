...
export function createFlashCards(): FlashCard[] {
  return [
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "cp" }),
      "_ are simply sequences of chords.", "chord progressions"),
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "cp,i" }),
    ...
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "bass" }),
    ...
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "tonicChords" }),
      "The diatonic chords that are considered \"tonic\" chords are:", "I, III, VI"),
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "preDominantChords" }),
      "The diatonic chords that are considered \"pre-dominant\" chords are:", "II, IV"),
    FlashCard.fromRenderFns(
      createFlashCardId(flashCardSetId, { id: "dominantChords" }),
