...
export function createFlashCards(): FlashCard[] {
  return [
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "P1" }),
      new FlashCardSide("P1"),
      new FlashCardSide("0", "P1")
    ),
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "m2" }),
    ...
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "m3" }),
    ...
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "P4" }),
      new FlashCardSide("P4"),
      new FlashCardSide("5", "P4")
    ),
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "A4/d5" }),
      new FlashCardSide("A4/d5"),
      new FlashCardSide("6", "A4/d5")
    ),
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "P5" }),
      new FlashCardSide("P5"),
      new FlashCardSide("7", "P5")
    ),
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "m6" }),
    ...
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "m7" }),
    ...
    new FlashCard(
      createFlashCardId(flashCardSetId, { interval: "P8" }),
