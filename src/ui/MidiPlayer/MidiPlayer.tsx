...
import { findIntervalsChordsScales } from '../Tools/IntervalChordScaleFinder';
...
export class MidiPlayerView extends React.Component<{}, {}> {
  ...
  private async parseMidiFile() {
    const midi = await Midi.fromUrl(midiFile1);
