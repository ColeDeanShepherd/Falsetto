...
export const glossaryData = [
  ...
  new GlossaryEntry("chord", () => <span>a group of three or more notes played simultaneously</span>),
  ...
  new GlossaryEntry("flat", () => <span>lowered slightly in pitch</span>),
  ...
  new GlossaryEntry("scale degree", () => <span>the number of a note in a scale, in ascending order from the root, starting from 1</span>),
  new GlossaryEntry("sharp", () => <span>raised slightly in pitch</span>),
