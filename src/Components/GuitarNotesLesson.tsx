...
const diagram5NoteGroups = noteGroups;
const diagram5Notes = Utils.flattenArrays<GuitarNote>(diagram5NoteGroups
  .map(ng => ng.notes));
        ...
        <CardContent>
          ...
          <p style={{ textAlign: "center" }}>
            <GuitarFretboard
              width={fretboardWidth} height={fretboardHeight}
              pressedNotes={[]}
              renderExtrasFn={metrics => this.renderDiagramExtras(metrics, diagram3NoteGroups)}
            />
          </p>
          ...
          <p style={{ textAlign: "center" }}>
            <GuitarFretboard
              width={fretboardWidth} height={fretboardHeight}
              pressedNotes={[]}
              renderExtrasFn={metrics => this.renderDiagramExtras(metrics, diagram4NoteGroups)}
            />
          </p>
